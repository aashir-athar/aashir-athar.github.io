...
const pillars = [
  {
    ...
    title: 'Mobile-First',
    body: 'Every line of code written with the mobile UX in mind — smooth, responsive, and intuitive on both iOS and Android.',
    accent: '#06b6d4',
  },
  {
    icon: <Zap size={20} />,
    title: 'Performance Obsessed',
    body: '35% faster load times, 60fps animations, and zero post-launch crashes — performance is a feature, not an afterthought.',
    accent: '#f59e0b',
  },
  {
    icon: <Users size={20} />,
    title: 'Team Leader',
    body: 'Mentored 4 junior developers and led cross-functional teams to ship MVPs within 6–8 weeks at AppGlide Technologies.',
    accent: '#8b5cf6',
  },
  {
    icon: <Code size={20} />,
    title: 'Full-Stack Capable',
    body: 'Backend in Node.js/Express, databases in MongoDB/Supabase/Firebase — I own the full stack when needed.',
    accent: '#10b981',
  },
]
          ...
          >
            {pillars.map((p, i) => (
              <motion.div
                ...
                whileHover={{ y: -4, borderColor: `${p.accent}55` }}
                style={{
                  padding: '24px',
                  borderRadius: '16px',
              ...
              >
                <div style={{
                  ...
                  color: p.accent, marginBottom: '14px',
                }}>
                  {p.icon}
                </div>
                <h3 style={{
